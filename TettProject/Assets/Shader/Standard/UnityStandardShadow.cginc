...
{
    half metallicity = UNITY_ACCESS_INSTANCED_PROP(_Metallic_arr, _Metallic);
    #ifdef _METALLICGLOSSMAP
...
) : SV_Target
{
            ...
            half alpha = UNITY_ACCESS_INSTANCED_PROP(Props, _Color).a;
        #else
            fixed4 color = UNITY_ACCESS_INSTANCED_PROP(Props, _Color);
            half alpha = UNITY_SAMPLE_TEX2DARRAY(_MainTex,float3(i.tex.xy,UNITY_ACCESS_INSTANCED_PROP(Props, _Index))).a*color.a;
        #endif
