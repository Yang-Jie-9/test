...
public readonly struct PcmHeader
{
    ...
    public static PcmHeader FromStream(Stream pcmStream)
    {
        ...
        return new PcmHeader(bitDepth, audioSize, (int)pcmStream.Position, channelCount, sampleRate, byteRate, blockAlign, true); // audio start index
    }
    ...
    {
        Debug.Log("GetAudioFormatFromCode:" + code);
        switch (code)
        {
            case 1:     return "PCM";
            case 2:     return "ADPCM";
